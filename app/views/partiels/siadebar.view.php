<aside class="sidebar">
  ...
  <div>
    <a href="index.html" class="sidebar-logo">
      <img src="<?=ROOT?>/assets/images/logo.png" alt="site logo" class="light-logo">
      <img src="<?=ROOT?>/assets/images/logo-light.png" alt="site logo" class="dark-logo">
      <img src="<?=ROOT?>/assets/images/logo-icon.png" alt="site logo" class="logo-icon">
    </a>
  </div>
